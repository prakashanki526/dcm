            ...
            <div className='section px-3 md:px-24 lg:px-48 py-4 md:py-8 lg:py-10'>
                ...
                <div className='mt-4 md:mt-0 flex flex-col gap-6'>
                    <Fade direction="up" triggerOnce>
                        ...
                        <div className='flex flex-col lg:flex-row gap-4 bg-gradient-to-r from-orange-500 to-yellow-100 rounded-xl w-full p-4 md:p-6'>
                    ...
                    <Fade direction="up" triggerOnce>
                        ...
                        <div className='flex flex-col lg:flex-row-reverse gap-4 bg-gradient-to-r from-yellow-100 to-orange-500 rounded-xl w-full p-4 md:p-6'>
